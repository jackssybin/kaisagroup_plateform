...
public class BigDecimalUtil {
	...
	public static BigDecimal parseFromObject(Object obj) {
		return obj == null ? BIGDECIMAL_defaultValue : new BigDecimal(obj.toString());
	}
	 ...
	 * @return
	 */
	public static BigDecimal roundHalfUp(BigDecimal data, int digit) {
		return data == null ? BigDecimal.ZERO : data.setScale(digit, BigDecimal.ROUND_HALF_UP);
	}
	...
	public static BigDecimal parseObj2BigDecimal(Object obj) {
		...
		try {
			...
			KAISAException.getStacktrace(e);
